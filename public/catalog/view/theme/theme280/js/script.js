...
/******************************************************Aside box category**************************************************************************************/
$(document).ready(function(){
		jQuery('.box .box-category').find('li.parent').prepend('<i class="icon-plus-sign"></i>');
		jQuery('.box .box-category li.parent i').on("click", function(){
		if (jQuery(this).hasClass('icon-minus-sign')) { jQuery(this).removeClass('icon-minus-sign').parent('li.parent').find('> ul').slideToggle(); } 
			else {
			jQuery(this).addClass('icon-minus-sign').parent('li.parent').find('> ul').slideToggle();
			}
		});
