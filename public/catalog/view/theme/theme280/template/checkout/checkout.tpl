...
<div class="<?php if ($column_left or $column_right) { ?>span9<?php } ?> <?php if ($column_left and $column_right) { ?>span6<?php } ?> <?php if (!$column_right and !$column_left) { ?>span12 <?php } ?>" id="content"><?php echo $content_top; ?>
  ...
  <div class="checkout">
    <div id="checkout">
      ...
      <div class="checkout-content opt"></div>
    </div>
    <?php if (!$logged) { ?>
    <div id="payment-address">
      <div class="checkout-heading"><div class="marker-chekout"><span><?php echo $text_checkout_account; ?></span></div></div>
      <div class="checkout-content"></div>
    </div>
    <?php } else { ?>
    <div id="payment-address">
      <div class="checkout-heading"><div class="marker-chekout"><span><?php echo $text_checkout_payment_address; ?></span></div></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>
    <?php if ($shipping_required) { ?>
    <div id="shipping-address">
      <div class="checkout-heading"><div class="marker-chekout"><?php echo $text_checkout_shipping_address; ?></div></div>
      <div class="checkout-content"></div>
    </div>
    <div id="shipping-method">
      <div class="checkout-heading"><div class="marker-chekout"><?php echo $text_checkout_shipping_method; ?></div></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>
    <div id="payment-method">
      <div class="checkout-heading"><div class="marker-chekout"><?php echo $text_checkout_payment_method; ?></div></div>
      <div class="checkout-content"></div>
    </div>
    <div id="confirm">
      <div class="checkout-heading"><div class="marker-chekout"><?php echo $text_checkout_confirm; ?></div></div>
      <div class="checkout-content"></div>
    </div>
  </div>
...
$('#button-account').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-account').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-register').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-register').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme280/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme280/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-guest').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme280/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme280/image/close-1.png" alt="" class="close" /></div>');
