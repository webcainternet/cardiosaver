...
<div class="<?php if ($column_left or $column_right) { ?>span9<?php } ?> <?php if ($column_left and $column_right) { ?>span6<?php } ?> <?php if (!$column_right and !$column_left) { ?>span12 <?php } ?>" id="content"><?php echo $content_top; ?>
  ...
  <?php if ($attention) { ?>
  <div class="attention"><?php echo $attention; ?><img src="catalog/view/theme/theme280/image/remove-small.png" alt="" class="close" /></div>
  <?php } ?>
  <?php if ($success) { ?>
  <div class="success"><?php echo $success; ?><img src="catalog/view/theme/theme280/image/remove-small.png" alt="" class="close" /></div>
  <?php } ?>
  <?php if ($error_warning) { ?>
  <div class="warning"><?php echo $error_warning; ?><img src="catalog/view/theme/theme280/image/remove-small.png" alt="" class="close" /></div>
  <?php } ?>
		...
		<tbody>
		  <?php foreach ($products as $product) { ?>
			<?php if($product['recurring']): ?>
              <tr>
                  <td colspan="6" style="border:none;"><image src="catalog/view/theme/theme280/image/reorder.png" alt="" title="" style="float:left;" /><span style="float:left;line-height:18px; margin-left:10px;"> 
		  ...
		  <tr>
			...
			<td class="quantity"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
			  ...
			  &nbsp;<a href="<?php echo $product['remove']; ?>"><!--<img src="catalog/view/theme/theme280/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" />--><i class="icon-trash"></i></a>
			  </div>
			  </td>
		  ...
		  <tr>
			...
			<td class="quantity"><input type="text" name="" value="1" size="1" disabled="disabled" />
			  &nbsp;<a href="<?php echo $vouchers['remove']; ?>"><i class="icon-trash"></i></a></td>
  ...
  <div class="content shop-cart-content">
	...
	<table class="radio table table-bordered table-hover">
	  ...
	  <tr class="highlight">
			<td><label class="radio" for="use_coupon"><input type="radio" name="next" value="coupon" id="use_coupon" /><?php echo $text_use_coupon; ?></label></td>
	  </tr>
	  <?php } ?>
	  <?php if ($voucher_status) { ?>
	  <tr class="highlight">
		 <td><label class="radio" for="use_voucher"><input type="radio" name="next" value="voucher" id="use_voucher" /><?php echo $text_use_voucher; ?></label></td>
	  </tr>
	  <?php } ?>
	  <?php if ($reward_status) { ?>
	  <tr class="highlight">
		
		<td><label class="radio" for="use_reward"><input type="radio" name="next" value="reward" id="use_reward" /><?php echo $text_use_reward; ?></label></td>
	  </tr>
	  <?php } ?>
	  <?php if ($shipping_status) { ?>
	  <tr class="highlight">
		
		<td><label class="radio" for="shipping_estimate"><input type="radio" name="next" value="shipping" id="shipping_estimate" /><?php echo $text_shipping_estimate; ?></label></td>
	  </tr>
	  <?php } ?>
	</table>
  </div>
  <div class="cart-module">
	<div id="coupon" class="content">
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="coup">
			<div class="control-group">
				<label class="control-label" for="coupon"><?php echo $entry_coupon; ?>&nbsp;</label>
				<div class="controls">
					<input type="text" name="coupon" value="<?php echo $coupon; ?>" />
					<input type="hidden" name="next" value="coupon" />&nbsp;
					<a onclick="$('#coup').submit();" class="button-cont-right"><?php echo $button_coupon; ?><i class="icon-circle-arrow-right"></i></a>
				</div>
			</div>
		</form>
	</div>
	...
	<div id="reward" class="content">
		<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="rew">
			<div class="control-group">
				<label class="control-label" for="reward"><?php echo $entry_reward; ?>&nbsp;</label>
				<div class="controls">
					<input type="text" name="reward" value="<?php echo $reward; ?>" />
					<input type="hidden" name="next" value="reward" />
					&nbsp;
					<a onclick="$('#rew').submit();" class="button-cont-right"><?php echo $button_reward; ?><i class="icon-circle-arrow-right"></i></a>
				</div>
			</div>
		</form>
	</div>
	<div id="shipping" class="content">
	  ...
	  <table class="form-horizontal">
		...
		<tr>
			<td>
				<div class="control-group">
					<label class="control-label" for="zone_id"><span id="postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></label>
					<div class="controls">
		...
		<tr>
			<td>
				<div class="control-group">
					<div class="controls">
						<a id="button-quote" class="button-cont-right"><?php echo $button_quote; ?><i class="icon-circle-arrow-right"></i></a>
					</div>
				</div>
			</td>
		</tr>
...
$('#button-quote').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-quote').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('#notification').html('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme280/image/close-1.png" alt="" class="close" /></div>');
...
$('select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme280/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
