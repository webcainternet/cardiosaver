		  ...
		  <?php 
			...
			<li class="<?php echo $a. $last_line ;?> span<?php echo $spanLine ;?>">
					...
					<div  class="quick-view<?php echo $i;?> preview">
						<div class="wrapper marg row-fluid">
							...
							<div class="right span8">
								...
								<div class="clear"></div>
								<div class="rating">
									<img height="18" src="catalog/view/theme/theme280/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
				...
				<div class="inner">
					...
					<div class="cart-button">
						<div class="cart"><a title="<?php echo $button_cart; ?>" data-id="<?php echo $product['product_id']; ?>;" class="button addToCart button-i"><i class="icon-shopping-cart"></i><!--<span><?php echo $button_cart; ?></span>--></a><a href="<?php echo $product['href']; ?>" class="button details"><span><?php echo $button_details; ?></span></a></div>
