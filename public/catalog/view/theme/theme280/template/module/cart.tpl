<div id="cart" >
  ...
  <div class="content-scroll">
	...
	<?php
	 ...
	 ?>
	 <span class="latest-added">Últimos adicionados</span>
		 <br />
		 <br />
	  ...
	  <table class="cart">
		...
		<tr>
		  ...
		  <td class="name"><?php echo $voucher['description']; ?>
			<div class="remove"><span><a alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" onclick="(getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') ? location = 'index.php?route=checkout/cart&remove=<?php echo $voucher['key']; ?>' : $('#cart').load('index.php?route=module/cart&remove=<?php echo $voucher['key']; ?>' + ' #cart > *');" href="#"><i class="icon-remove-sign" ></i><?php echo $button_remove; ?></a></span></div>
			</td>
