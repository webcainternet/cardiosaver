...
<div class="wrappPage"><div id="page">
<div id="shadow">
	...
	<div class="">
		...
		<div class="">
			<div class="">
				...
				<div id="search">
					<div class="inner">
						<div class="button-search"><i class="icon-double-angle-right"></i><!--<?php echo $text_search; ?>--></div>
		...
		<?php if ($categories) { ?>
		<div class="menuGadgetBox"><div class="menuGadgetContainer"><div id="menu-gadget">
        <div class="">
			<div class="">
...
<div class="container">
<?php if ($error) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme280/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
